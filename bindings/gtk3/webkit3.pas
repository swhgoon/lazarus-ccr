...
begin
  WebKit3.webkit_dom_event_target_dispatch_event(@self, event, error);
end;
...
begin
  Result := WebKit3.webkit_dom_node_append_child(@self, newChild, error);
end;
...
begin
  Result := WebKit3.webkit_dom_node_dispatch_event(@self, event, error);
end;
...
begin
  Result := WebKit3.webkit_dom_node_insert_before(@self, newChild, refChild, error);
end;

function TWebKitDOMNode.is_default_namespace(namespaceURI: Pgchar): gboolean; cdecl;
begin
  Result := WebKit3.webkit_dom_node_is_default_namespace(@self, namespaceURI);
end;
...
begin
  Result := WebKit3.webkit_dom_node_lookup_prefix(@self, namespaceURI);
end;
...
begin
  Result := WebKit3.webkit_dom_node_remove_child(@self, oldChild, error);
end;
...
begin
  Result := WebKit3.webkit_dom_node_replace_child(@self, newChild, oldChild, error);
end;

procedure TWebKitDOMNode.set_node_value(value: Pgchar; error: PPGError); cdecl;
begin
  WebKit3.webkit_dom_node_set_node_value(@self, value, error);
end;

procedure TWebKitDOMNode.set_prefix(value: Pgchar; error: PPGError); cdecl;
begin
  WebKit3.webkit_dom_node_set_prefix(@self, value, error);
end;

procedure TWebKitDOMNode.set_text_content(value: Pgchar; error: PPGError); cdecl;
begin
  WebKit3.webkit_dom_node_set_text_content(@self, value, error);
end;
...
begin
  WebKit3.webkit_dom_attr_set_value(@self, value, error);
end;
...
begin
  Result := WebKit3.webkit_dom_element_get_attribute_node_ns(@self, namespaceURI, localName);
end;

function TWebKitDOMElement.get_attribute_ns(namespaceURI: Pgchar; localName: Pgchar): Pgchar; cdecl;
begin
  Result := WebKit3.webkit_dom_element_get_attribute_ns(@self, namespaceURI, localName);
end;
...
begin
  Result := WebKit3.webkit_dom_element_get_class_list(@self);
end;

function TWebKitDOMElement.get_class_name: Pgchar; cdecl;
begin
  Result := WebKit3.webkit_dom_element_get_class_name(@self);
end;
...
begin
  Result := WebKit3.webkit_dom_element_get_elements_by_tag_name_ns(@self, namespaceURI, localName);
end;
...
begin
  Result := WebKit3.webkit_dom_element_get_webkit_region_overset(@self);
end;
...
begin
  Result := WebKit3.webkit_dom_element_has_attribute_ns(@self, namespaceURI, localName);
end;

function TWebKitDOMElement.query_selector(selectors: Pgchar; error: PPGError): PWebKitDOMElement; cdecl;
begin
  Result := WebKit3.webkit_dom_element_query_selector(@self, selectors, error);
end;

function TWebKitDOMElement.query_selector_all(selectors: Pgchar; error: PPGError): PWebKitDOMNodeList; cdecl;
begin
  Result := WebKit3.webkit_dom_element_query_selector_all(@self, selectors, error);
end;

procedure TWebKitDOMElement.remove(error: PPGError); cdecl;
begin
  WebKit3.webkit_dom_element_remove(@self, error);
end;
...
begin
  Result := WebKit3.webkit_dom_element_remove_attribute_node(@self, oldAttr, error);
end;

procedure TWebKitDOMElement.remove_attribute_ns(namespaceURI: Pgchar; localName: Pgchar); cdecl;
begin
  WebKit3.webkit_dom_element_remove_attribute_ns(@self, namespaceURI, localName);
end;
...
begin
  Result := WebKit3.webkit_dom_element_webkit_matches_selector(@self, selectors, error);
end;
...
begin
  WebKit3.webkit_dom_element_webkit_request_fullscreen(@self);
end;

procedure TWebKitDOMElement.webkit_request_pointer_lock; cdecl;
begin
  WebKit3.webkit_dom_element_webkit_request_pointer_lock(@self);
end;
...
begin
  Result := WebKit3.webkit_dom_blob_slice(@self, start, end_, contentType);
end;
...
begin
  WebKit3.webkit_dom_character_data_append_data(@self, data, error);
end;

procedure TWebKitDOMCharacterData.delete_data(offset: gulong; length: gulong; error: PPGError); cdecl;
begin
  WebKit3.webkit_dom_character_data_delete_data(@self, offset, length, error);
end;
...
begin
  Result := WebKit3.webkit_dom_text_replace_whole_text(@self, content, error);
end;

function TWebKitDOMText.split_text(offset: gulong; error: PPGError): PWebKitDOMText; cdecl;
begin
  Result := WebKit3.webkit_dom_text_split_text(@self, offset, error);
end;
...
begin
  WebKit3.webkit_dom_css_rule_set_css_text(@self, value, error);
end;
...
begin
  Result := WebKit3.webkit_dom_css_style_sheet_add_rule(@self, selector, style, index, error);
end;

procedure TWebKitDOMCSSStyleSheet.delete_rule(index: gulong; error: PPGError); cdecl;
begin
  WebKit3.webkit_dom_css_style_sheet_delete_rule(@self, index, error);
end;
...
begin
  Result := WebKit3.webkit_dom_css_style_sheet_insert_rule(@self, rule, index, error);
end;

procedure TWebKitDOMCSSStyleSheet.remove_rule(index: gulong; error: PPGError); cdecl;
begin
  WebKit3.webkit_dom_css_style_sheet_remove_rule(@self, index, error);
end;
...
begin
  Result := WebKit3.webkit_dom_css_style_declaration_get_property_css_value(@self, propertyName);
end;

function TWebKitDOMCSSStyleDeclaration.get_property_priority(propertyName: Pgchar): Pgchar; cdecl;
begin
  Result := WebKit3.webkit_dom_css_style_declaration_get_property_priority(@self, propertyName);
end;

function TWebKitDOMCSSStyleDeclaration.get_property_shorthand(propertyName: Pgchar): Pgchar; cdecl;
begin
  Result := WebKit3.webkit_dom_css_style_declaration_get_property_shorthand(@self, propertyName);
end;

function TWebKitDOMCSSStyleDeclaration.get_property_value(propertyName: Pgchar): Pgchar; cdecl;
begin
  Result := WebKit3.webkit_dom_css_style_declaration_get_property_value(@self, propertyName);
end;

function TWebKitDOMCSSStyleDeclaration.is_property_implicit(propertyName: Pgchar): gboolean; cdecl;
begin
  Result := WebKit3.webkit_dom_css_style_declaration_is_property_implicit(@self, propertyName);
end;
...
begin
  Result := WebKit3.webkit_dom_css_style_declaration_remove_property(@self, propertyName, error);
end;

procedure TWebKitDOMCSSStyleDeclaration.set_css_text(value: Pgchar; error: PPGError); cdecl;
begin
  WebKit3.webkit_dom_css_style_declaration_set_css_text(@self, value, error);
end;
...
begin
  WebKit3.webkit_dom_css_style_declaration_set_property(@self, propertyName, value, priority, error);
end;
...
begin
  WebKit3.webkit_dom_css_value_set_css_text(@self, value, error);
end;
...
begin
  Result := WebKit3.webkit_dom_dom_application_cache_dispatch_event(@self, evt, error);
end;
...
begin
  WebKit3.webkit_dom_dom_application_cache_swap_cache(@self, error);
end;

procedure TWebKitDOMDOMApplicationCache.update(error: PPGError); cdecl;
begin
  WebKit3.webkit_dom_dom_application_cache_update(@self, error);
end;
...
begin
  WebKit3.webkit_dom_event_init_event(@self, eventTypeArg, canBubbleArg, cancelableArg);
end;
...
begin
  Result := WebKit3.webkit_dom_dom_implementation_create_css_style_sheet(@self, title, media, error);
end;
...
begin
  Result := WebKit3.webkit_dom_dom_implementation_create_document(@self, namespaceURI, qualifiedName, doctype, error);
end;
...
begin
  Result := WebKit3.webkit_dom_dom_implementation_create_document_type(@self, qualifiedName, publicId, systemId, error);
end;
...
begin
  Result := WebKit3.webkit_dom_document_adopt_node(@self, source, error);
end;
...
begin
  Result := WebKit3.webkit_dom_document_create_attribute(@self, name, error);
end;
...
begin
  Result := WebKit3.webkit_dom_document_create_attribute_ns(@self, namespaceURI, qualifiedName, error);
end;

function TWebKitDOMDocument.create_cdata_section(data: Pgchar; error: PPGError): PWebKitDOMCDATASection; cdecl;
begin
  Result := WebKit3.webkit_dom_document_create_cdata_section(@self, data, error);
end;
...
begin
  Result := WebKit3.webkit_dom_document_create_element(@self, tagName, error);
end;
...
begin
  Result := WebKit3.webkit_dom_document_create_element_ns(@self, namespaceURI, qualifiedName, error);
end;

function TWebKitDOMDocument.create_entity_reference(name: Pgchar; error: PPGError): PWebKitDOMEntityReference; cdecl;
begin
  Result := WebKit3.webkit_dom_document_create_entity_reference(@self, name, error);
end;

function TWebKitDOMDocument.create_event(eventType: Pgchar; error: PPGError): PWebKitDOMEvent; cdecl;
begin
  Result := WebKit3.webkit_dom_document_create_event(@self, eventType, error);
end;
...
begin
  Result := WebKit3.webkit_dom_document_create_expression(@self, expression, resolver, error);
end;
...
begin
  Result := WebKit3.webkit_dom_document_create_node_iterator(@self, root, whatToShow, filter, expandEntityReferences, error);
end;

function TWebKitDOMDocument.create_ns_resolver(nodeResolver: PWebKitDOMNode): PWebKitDOMXPathNSResolver; cdecl;
begin
  Result := WebKit3.webkit_dom_document_create_ns_resolver(@self, nodeResolver);
end;
...
begin
  Result := WebKit3.webkit_dom_document_create_processing_instruction(@self, target, data, error);
end;
...
begin
  Result := WebKit3.webkit_dom_document_create_tree_walker(@self, root, whatToShow, filter, expandEntityReferences, error);
end;
...
begin
  Result := WebKit3.webkit_dom_document_evaluate(@self, expression, contextNode, resolver, type_, inResult, error);
end;

function TWebKitDOMDocument.exec_command(command: Pgchar; userInterface: gboolean; value: Pgchar): gboolean; cdecl;
begin
  Result := WebKit3.webkit_dom_document_exec_command(@self, command, userInterface, value);
end;
...
begin
  Result := WebKit3.webkit_dom_document_get_cookie(@self, error);
end;
...
begin
  Result := WebKit3.webkit_dom_document_get_element_by_id(@self, elementId);
end;
...
begin
  Result := WebKit3.webkit_dom_document_get_elements_by_name(@self, elementName);
end;
...
begin
  Result := WebKit3.webkit_dom_document_get_elements_by_tag_name_ns(@self, namespaceURI, localName);
end;
...
begin
  Result := WebKit3.webkit_dom_document_get_override_style(@self, element, pseudoElement);
end;
...
begin
  Result := WebKit3.webkit_dom_document_get_security_policy(@self);
end;
...
begin
  Result := WebKit3.webkit_dom_document_get_webkit_fullscreen_element(@self);
end;

function TWebKitDOMDocument.get_webkit_fullscreen_enabled: gboolean; cdecl;
begin
  Result := WebKit3.webkit_dom_document_get_webkit_fullscreen_enabled(@self);
end;
...
begin
  Result := WebKit3.webkit_dom_document_get_webkit_pointer_lock_element(@self);
end;
...
begin
  Result := WebKit3.webkit_dom_document_import_node(@self, importedNode, deep, error);
end;
...
begin
  Result := WebKit3.webkit_dom_document_query_selector(@self, selectors, error);
end;

function TWebKitDOMDocument.query_selector_all(selectors: Pgchar; error: PPGError): PWebKitDOMNodeList; cdecl;
begin
  Result := WebKit3.webkit_dom_document_query_selector_all(@self, selectors, error);
end;

procedure TWebKitDOMDocument.set_body(value: PWebKitDOMHTMLElement; error: PPGError); cdecl;
begin
  WebKit3.webkit_dom_document_set_body(@self, value, error);
end;
...
begin
  WebKit3.webkit_dom_document_set_cookie(@self, value, error);
end;
...
begin
  WebKit3.webkit_dom_document_set_xml_standalone(@self, value, error);
end;

procedure TWebKitDOMDocument.set_xml_version(value: Pgchar; error: PPGError); cdecl;
begin
  WebKit3.webkit_dom_document_set_xml_version(@self, value, error);
end;
...
begin
  WebKit3.webkit_dom_document_webkit_exit_fullscreen(@self);
end;

procedure TWebKitDOMDocument.webkit_exit_pointer_lock; cdecl;
begin
  WebKit3.webkit_dom_document_webkit_exit_pointer_lock(@self);
end;

function TWebKitDOMDocument.webkit_get_named_flows: PWebKitDOMDOMNamedFlowCollection; cdecl;
begin
  Result := WebKit3.webkit_dom_document_webkit_get_named_flows(@self);
end;
...
begin
  WebKit3.webkit_dom_document_type_remove(@self, error);
end;
...
begin
  WebKit3.webkit_dom_dom_selection_collapse(@self, node, index, error);
end;

procedure TWebKitDOMDOMSelection.collapse_to_end(error: PPGError); cdecl;
begin
  WebKit3.webkit_dom_dom_selection_collapse_to_end(@self, error);
end;

procedure TWebKitDOMDOMSelection.collapse_to_start(error: PPGError); cdecl;
begin
  WebKit3.webkit_dom_dom_selection_collapse_to_start(@self, error);
end;

function TWebKitDOMDOMSelection.contains_node(node: PWebKitDOMNode; allowPartial: gboolean): gboolean; cdecl;
begin
  Result := WebKit3.webkit_dom_dom_selection_contains_node(@self, node, allowPartial);
end;
...
begin
  WebKit3.webkit_dom_dom_selection_extend(@self, node, offset, error);
end;
...
begin
  Result := WebKit3.webkit_dom_dom_selection_get_range_at(@self, index, error);
end;
...
begin
  WebKit3.webkit_dom_dom_selection_select_all_children(@self, node, error);
end;
...
begin
  WebKit3.webkit_dom_dom_token_list_remove(@self, tokens, error);
end;

function TWebKitDOMDOMTokenList.toggle(token: Pgchar; force: gboolean; error: PPGError): gboolean; cdecl;
begin
  Result := WebKit3.webkit_dom_dom_token_list_toggle(@self, token, force, error);
end;
...
begin
  Result := WebKit3.webkit_dom_dom_window_atob(@self, string_, error);
end;
...
begin
  Result := WebKit3.webkit_dom_dom_window_btoa(@self, string_, error);
end;

procedure TWebKitDOMDOMWindow.cancel_animation_frame(id: glong); cdecl;
begin
  WebKit3.webkit_dom_dom_window_cancel_animation_frame(@self, id);
end;
...
begin
  Result := WebKit3.webkit_dom_dom_window_dispatch_event(@self, evt, error);
end;
...
begin
  Result := WebKit3.webkit_dom_dom_window_find(@self, string_, caseSensitive, backwards, wrap, wholeWord, searchInFrames, showDialog);
end;
...
begin
  Result := WebKit3.webkit_dom_dom_window_get_computed_style(@self, element, pseudoElement);
end;
...
begin
  Result := WebKit3.webkit_dom_dom_window_get_css(@self);
end;
...
begin
  Result := WebKit3.webkit_dom_dom_window_get_local_storage(@self, error);
end;
...
begin
  Result := WebKit3.webkit_dom_dom_window_get_performance(@self);
end;
...
begin
  Result := WebKit3.webkit_dom_dom_window_get_session_storage(@self, error);
end;
...
begin
  Result := WebKit3.webkit_dom_dom_window_get_webkit_storage_info(@self);
end;
...
begin
  Result := WebKit3.webkit_dom_dom_window_prompt(@self, message, defaultValue);
end;
...
begin
  Result := WebKit3.webkit_dom_navigator_is_protocol_handler_registered(@self, scheme, url, error);
end;
...
begin
  WebKit3.webkit_dom_navigator_register_protocol_handler(@self, scheme, url, title, error);
end;

procedure TWebKitDOMNavigator.unregister_protocol_handler(scheme: Pgchar; url: Pgchar; error: PPGError); cdecl;
begin
  WebKit3.webkit_dom_navigator_unregister_protocol_handler(@self, scheme, url, error);
end;

function TWebKitDOMNavigator.webkit_get_gamepads: PWebKitDOMGamepadList; cdecl;
begin
  Result := WebKit3.webkit_dom_navigator_webkit_get_gamepads(@self);
end;

function TWebKitDOMDOMWindowCSS.supports(property_: Pgchar; value: Pgchar): gboolean; cdecl;
begin
  Result := WebKit3.webkit_dom_dom_window_css_supports(@self, property_, value);
end;
...
begin
  Result := WebKit3.webkit_dom_document_fragment_query_selector(@self, selectors, error);
end;

function TWebKitDOMDocumentFragment.query_selector_all(selectors: Pgchar; error: PPGError): PWebKitDOMNodeList; cdecl;
begin
  Result := WebKit3.webkit_dom_document_fragment_query_selector_all(@self, selectors, error);
end;
...
begin
  Result := WebKit3.webkit_dom_xpath_expression_evaluate(@self, contextNode, type_, inResult, error);
end;
...
begin
  Result := WebKit3.webkit_dom_node_iterator_next_node(@self, error);
end;

function TWebKitDOMNodeIterator.previous_node(error: PPGError): PWebKitDOMNode; cdecl;
begin
  Result := WebKit3.webkit_dom_node_iterator_previous_node(@self, error);
end;
...
begin
  WebKit3.webkit_dom_processing_instruction_set_data(@self, value, error);
end;
...
begin
  WebKit3.webkit_dom_tree_walker_set_current_node(@self, value, error);
end;

function TWebKitDOMXPathResult.get_boolean_value(error: PPGError): gboolean; cdecl;
begin
  Result := WebKit3.webkit_dom_xpath_result_get_boolean_value(@self, error);
end;
...
begin
  Result := WebKit3.webkit_dom_xpath_result_get_number_value(@self, error);
end;
...
begin
  Result := WebKit3.webkit_dom_xpath_result_get_single_node_value(@self, error);
end;

function TWebKitDOMXPathResult.get_snapshot_length(error: PPGError): gulong; cdecl;
begin
  Result := WebKit3.webkit_dom_xpath_result_get_snapshot_length(@self, error);
end;

function TWebKitDOMXPathResult.get_string_value(error: PPGError): Pgchar; cdecl;
begin
  Result := WebKit3.webkit_dom_xpath_result_get_string_value(@self, error);
end;

function TWebKitDOMXPathResult.iterate_next(error: PPGError): PWebKitDOMNode; cdecl;
begin
  Result := WebKit3.webkit_dom_xpath_result_iterate_next(@self, error);
end;

function TWebKitDOMXPathResult.snapshot_item(index: gulong; error: PPGError): PWebKitDOMNode; cdecl;
begin
  Result := WebKit3.webkit_dom_xpath_result_snapshot_item(@self, index, error);
end;
...
begin
  Result := WebKit3.webkit_dom_html_element_insert_adjacent_element(@self, where, element, error);
end;

procedure TWebKitDOMHTMLElement.insert_adjacent_html(where: Pgchar; html: Pgchar; error: PPGError); cdecl;
begin
  WebKit3.webkit_dom_html_element_insert_adjacent_html(@self, where, html, error);
end;

procedure TWebKitDOMHTMLElement.insert_adjacent_text(where: Pgchar; text: Pgchar; error: PPGError); cdecl;
begin
  WebKit3.webkit_dom_html_element_insert_adjacent_text(@self, where, text, error);
end;
...
begin
  WebKit3.webkit_dom_html_element_set_content_editable(@self, value, error);
end;
...
begin
  WebKit3.webkit_dom_html_element_set_inner_html(@self, value, error);
end;

procedure TWebKitDOMHTMLElement.set_inner_text(value: Pgchar; error: PPGError); cdecl;
begin
  WebKit3.webkit_dom_html_element_set_inner_text(@self, value, error);
end;
...
begin
  WebKit3.webkit_dom_html_element_set_outer_html(@self, value, error);
end;

procedure TWebKitDOMHTMLElement.set_outer_text(value: Pgchar; error: PPGError); cdecl;
begin
  WebKit3.webkit_dom_html_element_set_outer_text(@self, value, error);
end;
...
begin
  Result := WebKit3.webkit_dom_named_node_map_get_named_item_ns(@self, namespaceURI, localName);
end;
...
begin
  Result := WebKit3.webkit_dom_named_node_map_remove_named_item(@self, name, error);
end;
...
begin
  Result := WebKit3.webkit_dom_named_node_map_remove_named_item_ns(@self, namespaceURI, localName, error);
end;

function TWebKitDOMNamedNodeMap.set_named_item(node: PWebKitDOMNode; error: PPGError): PWebKitDOMNode; cdecl;
begin
  Result := WebKit3.webkit_dom_named_node_map_set_named_item(@self, node, error);
end;

function TWebKitDOMNamedNodeMap.set_named_item_ns(node: PWebKitDOMNode; error: PPGError): PWebKitDOMNode; cdecl;
begin
  Result := WebKit3.webkit_dom_named_node_map_set_named_item_ns(@self, node, error);
end;
...
begin
  Result := WebKit3.webkit_dom_gamepad_get_id(@self);
end;

function TWebKitDOMGamepad.get_index: gulong; cdecl;
begin
  Result := WebKit3.webkit_dom_gamepad_get_index(@self);
end;

function TWebKitDOMGamepad.get_timestamp: guint64; cdecl;
begin
  Result := WebKit3.webkit_dom_gamepad_get_timestamp(@self);
end;

function TWebKitDOMGamepadList.get_length: gulong; cdecl;
begin
  Result := WebKit3.webkit_dom_gamepad_list_get_length(@self);
end;

function TWebKitDOMGamepadList.item(index: gulong): PWebKitDOMGamepad; cdecl;
begin
  Result := WebKit3.webkit_dom_gamepad_list_item(@self, index);
end;

procedure TWebKitDOMGeolocation.clear_watch(watchID: glong); cdecl;
begin
  WebKit3.webkit_dom_geolocation_clear_watch(@self, watchID);
end;
...
begin
  WebKit3.webkit_dom_html_media_element_set_current_time(@self, value, error);
end;
...
begin
  WebKit3.webkit_dom_html_media_element_set_volume(@self, value, error);
end;
...
begin
  Result := WebKit3.webkit_dom_validity_state_get_bad_input(@self);
end;
...
begin
  Result := WebKit3.webkit_dom_html_field_set_element_get_disabled(@self);
end;

function TWebKitDOMHTMLFieldSetElement.get_elements: PWebKitDOMHTMLCollection; cdecl;
begin
  Result := WebKit3.webkit_dom_html_field_set_element_get_elements(@self);
end;
...
begin
  Result := WebKit3.webkit_dom_html_field_set_element_get_name(@self);
end;
...
begin
  WebKit3.webkit_dom_html_field_set_element_set_disabled(@self, value);
end;

procedure TWebKitDOMHTMLFieldSetElement.set_name(value: Pgchar); cdecl;
begin
  WebKit3.webkit_dom_html_field_set_element_set_name(@self, value);
end;
...
begin
  Result := WebKit3.webkit_dom_html_iframe_element_get_seamless(@self);
end;
...
begin
  Result := WebKit3.webkit_dom_html_iframe_element_get_srcdoc(@self);
end;
...
begin
  WebKit3.webkit_dom_html_iframe_element_set_seamless(@self, value);
end;
...
begin
  WebKit3.webkit_dom_html_iframe_element_set_srcdoc(@self, value);
end;
...
begin
  Result := WebKit3.webkit_dom_html_input_element_get_capture(@self);
end;
...
begin
  Result := WebKit3.webkit_dom_html_input_element_get_height(@self);
end;
...
begin
  Result := WebKit3.webkit_dom_html_input_element_get_width(@self);
end;
...
begin
  WebKit3.webkit_dom_html_input_element_set_capture(@self, value);
end;
...
begin
  WebKit3.webkit_dom_html_input_element_set_files(@self, value);
end;
...
begin
  WebKit3.webkit_dom_html_input_element_set_height(@self, value);
end;
...
begin
  WebKit3.webkit_dom_html_input_element_set_max_length(@self, value, error);
end;
...
begin
  WebKit3.webkit_dom_html_input_element_set_range_text(@self, replacement, start, end_, selectionMode, error);
end;
...
begin
  WebKit3.webkit_dom_html_input_element_set_size(@self, value, error);
end;
...
begin
  WebKit3.webkit_dom_html_input_element_set_value_as_number(@self, value, error);
end;
...
begin
  WebKit3.webkit_dom_html_input_element_set_width(@self, value);
end;

procedure TWebKitDOMHTMLInputElement.step_down(n: glong; error: PPGError); cdecl;
begin
  WebKit3.webkit_dom_html_input_element_step_down(@self, n, error);
end;

procedure TWebKitDOMHTMLInputElement.step_up(n: glong; error: PPGError); cdecl;
begin
  WebKit3.webkit_dom_html_input_element_step_up(@self, n, error);
end;
...
begin
  WebKit3.webkit_dom_html_marquee_element_set_loop(@self, value, error);
end;

procedure TWebKitDOMHTMLMarqueeElement.set_scroll_amount(value: glong; error: PPGError); cdecl;
begin
  WebKit3.webkit_dom_html_marquee_element_set_scroll_amount(@self, value, error);
end;

procedure TWebKitDOMHTMLMarqueeElement.set_scroll_delay(value: glong; error: PPGError); cdecl;
begin
  WebKit3.webkit_dom_html_marquee_element_set_scroll_delay(@self, value, error);
end;
...
begin
  Result := WebKit3.webkit_dom_time_ranges_end(@self, index, error);
end;
...
begin
  Result := WebKit3.webkit_dom_time_ranges_start(@self, index, error);
end;
...
begin
  Result := WebKit3.webkit_dom_html_script_element_get_cross_origin(@self);
end;
...
begin
  Result := WebKit3.webkit_dom_html_script_element_get_nonce(@self);
end;
...
begin
  WebKit3.webkit_dom_html_script_element_set_cross_origin(@self, value);
end;
...
begin
  WebKit3.webkit_dom_html_script_element_set_nonce(@self, value);
end;
...
begin
  WebKit3.webkit_dom_html_select_element_add(@self, element, before, error);
end;
...
begin
  Result := WebKit3.webkit_dom_html_select_element_get_selected_options(@self);
end;
...
begin
  WebKit3.webkit_dom_html_select_element_set_length(@self, value, error);
end;
...
begin
  Result := WebKit3.webkit_dom_html_table_element_create_t_body(@self);
end;
...
begin
  WebKit3.webkit_dom_html_table_element_delete_row(@self, index, error);
end;
...
begin
  Result := WebKit3.webkit_dom_html_table_element_insert_row(@self, index, error);
end;
...
begin
  WebKit3.webkit_dom_html_table_element_set_caption(@self, value, error);
end;
...
begin
  WebKit3.webkit_dom_html_table_element_set_t_foot(@self, value, error);
end;

procedure TWebKitDOMHTMLTableElement.set_t_head(value: PWebKitDOMHTMLTableSectionElement; error: PPGError); cdecl;
begin
  WebKit3.webkit_dom_html_table_element_set_t_head(@self, value, error);
end;
...
begin
  WebKit3.webkit_dom_html_table_section_element_delete_row(@self, index, error);
end;
...
begin
  Result := WebKit3.webkit_dom_html_table_section_element_insert_row(@self, index, error);
end;
...
begin
  WebKit3.webkit_dom_html_table_row_element_delete_cell(@self, index, error);
end;
...
begin
  Result := WebKit3.webkit_dom_html_table_row_element_insert_cell(@self, index, error);
end;
...
begin
  WebKit3.webkit_dom_html_text_area_element_set_max_length(@self, value, error);
end;
...
begin
  WebKit3.webkit_dom_html_text_area_element_set_range_text(@self, replacement, start, end_, selectionMode, error);
end;
...
begin
  WebKit3.webkit_dom_html_video_element_webkit_enter_full_screen(@self, error);
end;

procedure TWebKitDOMHTMLVideoElement.webkit_enter_fullscreen(error: PPGError); cdecl;
begin
  WebKit3.webkit_dom_html_video_element_webkit_enter_fullscreen(@self, error);
end;
...
begin
  Result := WebKit3.webkit_dom_location_get_ancestor_origins(@self);
end;
...
begin
  WebKit3.webkit_dom_media_list_append_medium(@self, newMedium, error);
end;

procedure TWebKitDOMMediaList.delete_medium(oldMedium: Pgchar; error: PPGError); cdecl;
begin
  WebKit3.webkit_dom_media_list_delete_medium(@self, oldMedium, error);
end;
...
begin
  WebKit3.webkit_dom_media_list_set_media_text(@self, value, error);
end;
...
begin
  WebKit3.webkit_dom_ui_event_init_ui_event(@self, type_, canBubble, cancelable, view, detail);
end;
...
begin
  Result := WebKit3.webkit_network_response_get_suggested_filename(@self);
end;
...
begin
  Result := WebKit3.webkit_favicon_database_get_favicon_pixbuf_finish(@self, result_, error);
end;
...
begin
  Result := WebKit3.webkit_file_chooser_request_get_mime_types(@self);
end;

function TWebKitFileChooserRequest.get_mime_types_filter: PGtkFileFilter; cdecl;
begin
  Result := WebKit3.webkit_file_chooser_request_get_mime_types_filter(@self);
end;

function TWebKitFileChooserRequest.get_select_multiple: gboolean; cdecl;
begin
  Result := WebKit3.webkit_file_chooser_request_get_select_multiple(@self);
end;

function TWebKitFileChooserRequest.get_selected_files: PPgchar; cdecl;
begin
  Result := WebKit3.webkit_file_chooser_request_get_selected_files(@self);
end;

procedure TWebKitFileChooserRequest.select_files(files: PPgchar); cdecl;
begin
  WebKit3.webkit_file_chooser_request_select_files(@self, files);
end;
...
begin
  Result := WebKit3.webkit_web_frame_get_dom_document(@self);
end;
...
begin
  Result := WebKit3.webkit_web_frame_print_full(@self, operation, action, error);
end;
...
begin
  Result := WebKit3.webkit_web_view_get_snapshot(@self);
end;
