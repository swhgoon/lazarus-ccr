...
begin
  Result := Gio2.g_file_new_tmp(tmpl, iostream);
end;
...
begin
  Result := Gio2.g_dbus_connection_export_action_group(@self, object_path, action_group);
end;

function TGDBusConnection.export_menu_model(object_path: Pgchar; menu: PGMenuModel): guint; cdecl;
begin
  Result := Gio2.g_dbus_connection_export_menu_model(@self, object_path, menu);
end;
...
begin
  Result := Gio2.g_inet_address_mask_new(addr, length);
end;

function TGInetAddressMask.new_from_string(mask_string: Pgchar): PGInetAddressMask; cdecl;
begin
  Result := Gio2.g_inet_address_mask_new_from_string(mask_string);
end;
...
begin
  Result := Gio2.g_network_monitor_can_reach(@self, connectable, cancellable);
end;
...
begin
  Result := Gio2.g_network_monitor_can_reach_finish(@self, result_);
end;
...
begin
  Result := Gio2.g_resource_new_from_data(data);
end;
...
begin
  Result := Gio2.g_resource_load(filename);
end;
...
begin
  Result := Gio2.g_settings_schema_source_new_from_directory(directory, parent, trusted);
end;
...
begin
  Result := Gio2.g_socket_condition_timed_wait(@self, condition, timeout, cancellable);
end;
...
begin
  Result := Gio2.g_socket_join_multicast_group(@self, group, source_specific, iface);
end;

function TGSocket.leave_multicast_group(group: PGInetAddress; source_specific: gboolean; iface: Pgchar): gboolean; cdecl;
begin
  Result := Gio2.g_socket_leave_multicast_group(@self, group, source_specific, iface);
end;
...
begin
  Result := Gio2.g_socket_connection_connect(@self, address, cancellable);
end;
...
begin
  Result := Gio2.g_socket_connection_connect_finish(@self, result_);
end;
...
begin
  Result := Gio2.g_unix_connection_receive_credentials_finish(@self, result_);
end;
...
begin
  Result := Gio2.g_unix_connection_send_credentials_finish(@self, result_);
end;
