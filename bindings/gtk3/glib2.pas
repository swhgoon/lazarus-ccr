...
begin
  Result := GLib2.g_mapped_file_new_from_fd(fd, writable);
end;
...
begin
  Result := GLib2.g_thread_try_new(name, func, data);
end;
...
begin
  Result := GLib2.g_thread_pool_push(@self, data);
end;

function TGThreadPool.set_max_threads(max_threads: gint): gboolean; cdecl;
begin
  Result := GLib2.g_thread_pool_set_max_threads(@self, max_threads);
end;
